...
public class CorridaServiceTest extends BaseTest {
	...
	@Sql({ "classpath:/resources/sql/campeonato.sql", "classpath:/resources/sql/pais.sql",
	...
	@Sql({ "classpath:/resources/sql/campeonato.sql", "classpath:/resources/sql/pais.sql",
			"classpath:/resources/sql/pista.sql", "classpath:/resources/sql/corrida.sql" })
	void updateTest() {
	...
	void findByPistaNotFoundTest() {
		var exception = assertThrows(ObjetoNaoEncontrado.class,
				() -> corridaService.findByPista(new Pista(3, null, null)));
